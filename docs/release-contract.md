...
Project: `EasyRegister`

Release class: `single-runtime-image`
...
| --- | --- | --- | --- | --- |
| `runtime` | `.github/workflows/publish-ghcr-image.yml` | `release_tag, version` | `easyregister-runtime-r2-config-manifest, easyregister-import-code-encrypted, runtime-r2-config-manifest, runtime-import-code-encrypted` | GHCR, R2, import-code |

## Project-specific exceptions

- The runtime image is not a service/base component, so workflow naming remains publish-ghcr-image.yml.
